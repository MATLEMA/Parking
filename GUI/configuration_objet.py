...
class Configuration_SP3(LabelFrame):
    ...
    def __init__(self, parent, dict_des_objets : dict[str,dict[str,str]], liste_des_instances_appareil : list[Appareil | SP3 | DX3], listbox : Listbox ):
        super().__init__(parent, text= "Configuration du SP3")

        self.listbox: Listbox = listbox
        self.dict_des_objets: dict[str, dict[str, str]] = dict_des_objets
        ...
        afficher_port_com.insert(0, dict_des_objets[port_objet]["port"])
        ...
        afficher_modele_objet.insert(0, dict_des_objets[port_objet]["modele"])
        ...
        afficher_version_objet.insert(0, dict_des_objets[port_objet]["version"])
